...
// smtp.user / mailjet.apiKey are included because for Mailjet the SMTP username
// IS the API key — half of the credential pair.
const SECRET_SETTING_KEYS = ["smtp.pass", "mailjet.apiSecret", "smtp.user", "mailjet.apiKey"];
